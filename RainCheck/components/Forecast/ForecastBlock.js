...
const getWeatherData = (viewMode, daily, weekly) => {
  ...
  if (viewMode === "daily") {
    ...
    return Array.from({ length: 48 }, (_, index) => {
      ...
      return {
        day: nextHour.toLocaleDateString("en-US", {
          month: "numeric",
          day: "numeric",
        }),
        formattedHour: `${nextHour
          .getHours()
          .toString()
          .padStart(2, "0")}:${"00"}`,
        imagePathWeather: parseShortForecast(
          daily[`${index}`]["shortForecast"]
        ),
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Text
            style={[
              ...
              viewMode === "daily" && styles.activeButtonText,
            ]}
          >
            Daily
          </Text>
        ...
        >
          <Text
            style={[
              styles.toggleButtonText,
              viewMode === "weekly" && styles.activeButtonText,
            ]}
          >
            Weekly
          </Text>
...
const styles = StyleSheet.create({
  ...
  leftBar: {
    ...
    backgroundColor: "antiquewhite", // Add a background color for visibility
  },
  spaceBetween: {
    height: 40, // Use remaining space in the container
  },
  toggleButton: {
